...
void eigenFaceTrainer() {
	...
	try {
		string filename = "E:/csv.ext";	//csv file created by python script
	...
	model->save("C:/Users/GrimReaper/Desktop/SIHeigenface.yml");
...
Ptr<FaceRecognizer>  model = FisherFaceRecognizer::create();
char *pp = "C:/Users/GrimReaper/Desktop/SIHeigenface.yml";
model->read(pp);

Mat testSample = imread("C:/Users/GrimReaper/Desktop/SIH/Data/s1/1.pgm", 0);
...
string classifier = "C:/Opencv3/install/etc/haarcascades/haarcascade_frontalface_default.xml";
...
putText(original, text, Point(pos_x, pos_y), FONT_HERSHEY_COMPLEX_SMALL, 1, CV_RGB(0, 255, 0), 1);
//cv::imwrite("E:/FDB/"+frameset+".jpg", cropImg);

}


putText(original, "Frames: " + frameset, Point(30, 60), CV_FONT_HERSHEY_COMPLEX_SMALL, 1, CV_RGB(0, 255, 0), 1);
putText(original, "Person: " + Pname, Point(30, 90), CV_FONT_HERSHEY_COMPLEX_SMALL, 1, CV_RGB(0, 255, 0), 1);
